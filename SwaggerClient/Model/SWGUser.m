...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"userLastName", @"userMobileNo", @"userHandedness", @"userCity", @"userLocality", @"userIsReal", @"userBirthdate", @"userAge", @"userStatusMessage", @"userTotalMatches", @"userTotalMatchesWon", ];
