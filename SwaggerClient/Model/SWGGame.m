...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"gameId", @"gameSport", @"gameType", @"gameScoreFormat", @"gameChallengerScore", @"gameOppositionScore", @"gameChallengerPlayer1", @"gameChallengerPlayer2", @"gameOppositionPlayer1", @"gameOppositionPlayer2", @"gameIsVerified", @"gameCreatedTs", @"gameVerifiedTs", @"gameChallengerPlayer1Profile", @"gameChallengerPlayer2Profile", @"gameOppositionPlayer1Profile", @"gameOppositionPlayer2Profile"];
